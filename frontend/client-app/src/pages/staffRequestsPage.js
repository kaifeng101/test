  ...
  const filteredRequests = () => {
    ...
    return wfhrequests.filter(request => {
      ...
      switch (tabIndex) {
        ...
        case 1: // My Approved Requests
          return isRequesterId && request.entries.some(entry => entry.status === 'Approved');
        case 2: // My Reviewed Requests
    ...
    return (
      ...
      <TabPanel value={tabIndex} index={0}>
          <StaffTablePendingReq fetchWFHRequests={filteredRequests()}/>
      </TabPanel>
